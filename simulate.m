...
import metabolic_symbiosis_2d.*;
import util.*;
import external.*;

%% load operating parameters

metabolic_symbiosis_2d.load_operating_parameters;
...
for tick = 1 : num_iters
    ...
    for ct = 1 : num_cell_types
        ...
        if z_dim > 1
            epc(ct, tick) = external.imEuler3d(occupation_ct);
        else
            epc(ct, tick) = external.imEuler2d(occupation_ct);
        end
