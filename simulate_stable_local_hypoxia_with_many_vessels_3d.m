function [] = simulate_stable_local_hypoxia_with_many_vessels_3d()
...
if output_results
    ...
    mkdir(path);
    copyfile('simulate_stable_local_hypoxia_with_many_vessels_3d.m', path);
...
end  % function simulate_stable_local_hypoxia_with_many_vessels_3d
